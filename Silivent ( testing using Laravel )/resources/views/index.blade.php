  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <a href="list" class="btn btn-primary btn-xl rounded-pill mt-5">Lihat Event & Lomba</a>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="p-5">
            <a href="detailgemastik" style="color: black;"><h2 class="display-4">Gemastik XII</h2></a>
