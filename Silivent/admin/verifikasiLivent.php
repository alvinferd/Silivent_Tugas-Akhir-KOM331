...
<body>	
	...
	<section class="section parallax-section parallax-section-padding-top-bottom-pagetop section-page-top-title">
      ...
      <div style="text-align: center; margin-top: 5%; margin-bottom: -5%">
        ...
        <a href="listLiventDiajukan.php" class="button-shortcodes text-size-4 text-padding-4 version-2">Data Semua Event atau Lomba</a>
      </div>
    </section>
    	...
    	<div class="call-to-action-2">
    		<div class="container">
    			<div class="sixteen columns">
    				<h6>Verifikasi Event atau Lomba</h6>
    			</div>
    		</div>
    	</div>
    </section> 	
