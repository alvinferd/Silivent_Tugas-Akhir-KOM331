...
<body class="bg-warning">
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        ...
        <a href="verifikasiLivent.php" class="btn btn-primary btn-xl rounded-pill mt-5">Verifikasi Event atau Lomba</a>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <br>
      <br>
      <h1 style="text-align: center;">Rekomendasi Lomba & Event Favorit</h1>
  ...
  function berhasilBerhasilBerhasilHore() {
    alert("Lomba/Event berhasil ditambahkan");
  }
  </script>
