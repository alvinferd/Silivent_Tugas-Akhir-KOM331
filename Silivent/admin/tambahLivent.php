...
<body>
  ...
  <div class="container">
    ...
    <div class="masthead-content">
      <div class="container">
        <h1 class="masthead-heading mb-0">Tambahkan Lomba dan Event</h1>
      </div>
    </div>
    ...
    <form action="LiventProc.php" method="post" enctype="multipart/form-data">
      <h2 class="masthead-subheading mb-0">Nama Lengkap Anda : </h2>
      <input type="text" size="100" name="creator" required>
      <br><br>
      <h2 class="masthead-subheading mb-0">Nama Institusi : </h2>
      <input type="text" name="institusi" size="100" required>
      <br><br>
     ...
     <textarea name="shortDesc" rows="5" cols="100" required></textarea>
      <br><br>
      <h2 class="masthead-subheading mb-0">Masukkan Deskripsi Lengkap : </h2>
      <textarea name="longDesc" rows="50" cols="100" required></textarea>
      <br><br>
      ...
      <br>
      <input type="submit" name="tambah" value="Submit" class="btn btn-primary btn-xl rounded-pill mt-5">
    </form>
    <br>
    <br>
